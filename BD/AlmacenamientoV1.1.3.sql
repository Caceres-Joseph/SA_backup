...
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Bitacora de cambios en la cadena, usuarios ';
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Guarda las cadenas de los complementos, por cada complemento N cadenas ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de Clientes del servicio de Almacenamiento, este microservicios que se subscribiran';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla en donde se guardan los complementos, y la o las localizaciones originales, aunque debe ser una sola ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de Estados de los Complementos';
/*!40101 SET character_set_client = @saved_cs_client */;
      ...
      /*Se puede utilizar el mismo procedimiento para insertar y para aprobar una traduccion,
        ...
        if _opcion = 1 then
            ...
            if (select count(*) from BitacoraCambio where idDetalleComplemento = _iddetallecomplemento and idestado = _idestado) < 2 then
				...
				select 201 estado, concat('La cadena tiene suficientes aprobaciones, es una cadena limpia ',_cadena) mensaje;
			end if;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_traducidoscomplementoTraducido`()
BEGIN
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
	  BEGIN
		select 401 estado,'Error al listar las traducciones Aprobadas ' mensaje;               
	...
	/*SELECT CO.idComplemento,CO.Complemento,L.Localizacion LocalizacionOriginal,L1.Localizacion LocalizacionTraduccion, C.Cadena msgid, C1.Cadena msgstr,ifnull(count(BC.idDetalleComplemento),0) numeroAprobaciones*/
